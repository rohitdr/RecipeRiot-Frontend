...
the adminactivepage state to the adminActivePageNumber. */
  ...
  return (
    <>
      ...
      {AdminAllUser === 500 ||
      AdminAllRecipe === 500 ||
      AdminAllUserByDate === 500 ||
      AdminAllRecipeByDate === 500 ||
      AllContactMessages === 500 ||
      deleteaccountAdmin === 500 ||
      deletemessageresult === 500 ||
      recipe === 500 ||
      staticalData === 500 ? (
                      ...
                      <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                          ...
                          <p className="mb-0">
                            ...
                            unique features or content you can offer to meet
                            their needs.
                          </p>
                        </div>
                      </div>
