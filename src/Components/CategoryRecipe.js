...
export default function CategoryRecipe() {
 ...
 <div className='flex gap-4 flex-col py-2'>
    <h1 className='text-2xl sm:text-4xl lg:text-6xl font-bold'>High Protein Recipes</h1>
         <p className='max-w-2xl text-white/70'>Discover powerful meals packed with protein to fuel your workouts, improve recovery, and keep you full longer.</p>
 </div>
 <div className='flex gap-4 pt-4'>
 <div className='text-xs lg:text-base rounded-3xl bg-white/10 px-2 sm:px-4 py-2 '>120+ Recipes</div>
...
<div className="flex flex-wrap gap-3 text-xs lg:text-base">
 ...
 {recipes.recipe.slice(0,20).map((recipe,index) => (
            <motion.div
              key={recipe._id}
...
<div className="flex justify-center py-10 px-3">
  ...
  <div className="flex items-center gap-2 bg-white/5 border border-white/10 backdrop-blur-xl px-3 sm:px-4 py-2 rounded-xl shadow-lg">
    ...
    {/* Prev */}
    <button className="px-3 py-2 text-xs sm:text-sm text-white/60 hover:text-white hover:bg-white/10 rounded-lg transition">
      Prev
    </button>
    ...
    <div className="flex items-center gap-1 sm:gap-2">
      ...
      <button className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg text-xs sm:text-sm text-white/60 hover:bg-white/10 hover:text-white transition">
        1
      </button>

      {/* Hide some numbers on mobile */}
      <button className="hidden sm:flex w-10 h-10 rounded-lg text-sm text-white/60 hover:bg-white/10 hover:text-white transition items-center justify-center">
        2
      </button>

      <button className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg text-xs sm:text-sm bg-white text-black font-semibold">
        3
      </button>
      ...
      <span className="hidden sm:block px-2 text-white/40">...</span>
